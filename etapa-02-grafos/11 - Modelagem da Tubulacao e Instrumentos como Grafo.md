...
Onde:
* $V=\{v_1,v_2,\dots,v_n\}$ é o conjunto finito de vértices (nós): tanques, reatores, bombas, manifolds e granuladores.
* $E \subseteq V \times V$ é o conjunto de arestas dirigidas (arcos) de tubulação com sentido de fluxo permitido.
* $W: E \to \mathbb{R}^+$ é a função de ponderação, que associa a cada duto um custo operacional (comprimento físico L [m] ou perda de carga $\Delta P$).

### Diagrama de Fluxo P&ID (Mermaid)
